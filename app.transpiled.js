...
var sites = JSON.parse(_fs["default"].readFileSync('./sites.json'));

// Store status records for each site
var statusRecords = {};

// Function to check site status
function checkSiteStatus(_x) {
  return _checkSiteStatus.apply(this, arguments);
} // Function to update status records
function _checkSiteStatus() {
  _checkSiteStatus = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(site) {
    var response;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _nodeFetch["default"])(site.url);
        case 3:
          response = _context.sent;
          return _context.abrupt("return", response.ok ? 'Online' : 'Offline');
        case 7:
          _context.prev = 7;
          _context.t0 = _context["catch"](0);
          return _context.abrupt("return", 'Offline');
        case 10:
        case "end":
...
function updateStatusRecords() {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      var status = checkSiteStatus(site);
